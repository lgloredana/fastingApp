...
import { ChevronLeft, ChevronRight, ArrowLeft, Dna, Brain, Zap, Shield, Target } from 'lucide-react';
...
const benefitsData = [
  {
    ...
    content: "După aproximativ 14–16 ore de pauză alimentară, corpul intră într-o stare de autofagie, un proces prin care celulele curăță și reciclează componentele uzate sau defecte. Acest mecanism este crucial pentru prevenirea bolilor neurodegenerative, cancerului și procesului de îmbătrânire celulară.",
  ...
  },
  {
    ...
    content: "Postul intermitent reduce nivelurile de insulină și crește sensibilitatea la leptină – hormonul sațietății. De asemenea, reglează secreția de grelină (hormonul foamei), ceea ce duce la un control mai bun al apetitului și reducerea consumului caloric spontan.",
  ...
  },
  {
    ...
    content: "După epuizarea rezervelor de glicogen (aprox. 12–16 ore de post), corpul începe să utilizeze acizi grași și corpi cetonici ca surse principale de energie. Acest proces ajută la reducerea masei grase viscerale și la stabilizarea glicemiei, fiind benefic în prevenția diabetului de tip 2.",
    reference: "",
  ...
  },
  {
    ...
    content: "Studiile arată că pauzele alimentare reglează expresia genelor implicate în inflamație și induc mecanisme de protecție celulară împotriva stresului oxidativ, reducând riscul de boli cronice cardiovasculare și autoimune.",
  ...
  },
  {
    ...
    content: "Prin creșterea nivelului de BDNF (Brain-Derived Neurotrophic Factor), pauzele alimentare pot susține neuroplasticitatea și memoria, oferind un beneficiu cognitiv semnificativ mai ales în perioadele de efort mental susținut.",
    reference: "",
...
export default function BeneficiiPage() {
  ...
  const prevSlide = () => {
    setCurrentSlide((prev) => (prev - 1 + benefitsData.length) % benefitsData.length);
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            🧬 De ce sunt importante pauzele alimentare?
          </h1>
        ...
        <div className="relative">
          <Card className={`${currentBenefit.color} ${currentBenefit.borderColor} border-2 min-h-[500px] transition-all duration-500`}>
        ...
        <Card className="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-blue-200 dark:border-blue-700">
          <CardContent className="p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Pauzele alimentare nu sunt doar un instrument pentru controlul greutății, ci reprezintă o intervenție metabolică cu efecte sistemice pozitive. Prin mecanisme evolutiv adaptative, corpul uman este conceput să funcționeze optim în cicluri de alimentație și repaus, iar valorificarea acestor pauze poate susține sănătatea pe termen lung, cu beneficii validate științific.
            </p>
          </CardContent>
        </Card>
      </div>
